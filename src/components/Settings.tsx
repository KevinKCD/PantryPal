  ...
  const sections = [
    {
      ...
      icon: User,
      desc: "Manage your personal information and public profile.",
    },
    {
      id: "notifications",
      label: "Notifications",
      ...
      <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100 shadow-sm overflow-hidden">
        {sections.map((section) => {
          ...
          return (
            <button
              key={section.id}
              className="w-full flex items-center p-4 md:p-6 hover:bg-gray-50 transition-colors text-left group"
            >
              ...
              <ChevronRight
                className="text-gray-300 group-hover:text-gray-500 ml-2 shrink-0"
                size={20}
              />
            </button>
          );
