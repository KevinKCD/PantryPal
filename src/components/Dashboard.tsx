    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Pantry Items</h3>
          <p className="text-3xl font-bold text-gray-900 mt-2">42</p>
          <p className="text-sm text-green-600 mt-2">↑ 3 new this week</p>
        </div>
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Planned Meals</h3>
          <p className="text-3xl font-bold text-gray-900 mt-2">7</p>
          <p className="text-sm text-gray-500 mt-2">Next: Chicken Stir Fry</p>
        </div>
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Saved Recipes</h3>
          <p className="text-3xl font-bold text-gray-900 mt-2">128</p>
          <p className="text-sm text-orange-600 mt-2">Explore new ideas</p>
        </div>
      </div>
